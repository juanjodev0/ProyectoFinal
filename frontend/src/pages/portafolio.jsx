          ...
          <div className="containe py-12">
            ...
            <div className="flex flex-wrap -mx-4 -mb-10 text-center">
              <div className="shadow-lg rounded-b-2xl sm:w-1/3 mb-10 box-border h120 w-32">
                ...
                <h2 className="title-font text-2xl font-medium text-gray-900 mt-6 mb-3 poppins-semibold">...</h2>
                <h3 className="leading-relaxed text-base text-primary poppins-medium bg-dark-color bg-opacity-10 mb-2">Valor: $<span className="poppins-regular text-dark-color">...</span></h3>
