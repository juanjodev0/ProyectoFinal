const Login = () => {
  ...
  <div className="container flex flex-wrap items-center">
    ...
    <img className="w-80 object-cover object-center place-items-center flex mx-auto" src="logo-negro.png" alt="logo Goat"></img>
      ...
      <button className="flex mx-auto mt-2 text-white bg-gradient-to-r rounded-3xl from-primary to-secundary border-0 py-1 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg poppins-regular">Iniciar Sesion</button>
